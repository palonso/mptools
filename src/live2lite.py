...
def main():
    parser = ArgumentParser(
        description="Convert an Ableton Live project to an Ableton Live Lite project."
    )
    parser.add_argument(
        "input_file", type=Path, help="Path to the input .als Ableton project file"
    )
